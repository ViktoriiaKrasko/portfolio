...
const modalViews = document.querySelectorAll('.projects__modal'),
      modalButtons = document.querySelectorAll('.projects__button'),
...
function scrollUp(){
    ...
    //when the scroll is higher than 560 vh - add the show scroll class to the taf with the scroll
...
//we validate if  user chose the theme before
if(selectedTheme) {
...
//activate/deactivate with button
